<div class="wrap">
	...
	<p>
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
			...
			<input type="image" src="https://www.paypalsmsects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
			<img alt="" border="0" src="https://www.paypalsmsects.com/en_US/i/scr/pixel.gif" width="1" height="1">
		</form>
		
		<hr />
		
		<p><a href="http://www.mostafa-soufi.ir/donate/" target="_blank"><img src="<?php echo WP_SMS_DIR_PLUGIN; ?>assets/images/donate/donate.png" id="donate" alt="<?php _e('Donate', 'wp_statistics'); ?>"/><br /><img src="<?php echo WP_SMS_DIR_PLUGIN; ?>assets/images/donate/tdCflg.png" id="donate" alt="<?php _e('Donate', 'wp_statistics'); ?>"/></a></p>
	</p>
</div>